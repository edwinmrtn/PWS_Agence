...
<form method="post" action="rechercheBiens.php">
   <p>
	       	...
	       	{	
				...
				echo  '<TR><TD>Détail Bien</TD><TD>Photo</TD><TD>Lien</TD></TR>';
					foreach($tablefetch as $donneestableau){
						echo '<TR><TD>' . preg_replace($patterns, $replacements, $donneestableau['detailBien']. '</TD> <TD> ' . ' <img " src="../images/'. $donneestableau['photoBien'] .'"alt="Image Maisons">' .  ' <TD> ' . '<a href="ajoutVisite.php?id='. $donneestableau['idBien']. '">Visiter </a></TD></TR>');
					}
				echo '</TABLE>';
				}
